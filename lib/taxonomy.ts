...
const categoryAliases: Record<string, CanonicalCategory[] | null> = {
  ...
  "legacy-game": ["Campaña / Legacy"],
  campaign: ["Campaña / Legacy"],
  "campaign-game": ["Campaña / Legacy"],
  ...
  "dungeon-crawlers": ["Dungeon Crawler"],
...
const mechanicAliases: Record<string, CanonicalMechanic[] | null> = {
  ...
  "movimiento-de-cuadricula": ["Movimiento en cuadrícula"],
  "movimiento-en-cuadricula": ["Movimiento en cuadrícula"],
  cuadricula: ["Movimiento en cuadrícula"],
  "modular-board": ["Tablero modular"],
  "tableros-modulares": ["Tablero modular"],
  "tablero-modular": ["Tablero modular"],
  scenarios: ["Escenarios/Misiones"],
  scenario: ["Escenarios/Misiones"],
  missions: ["Escenarios/Misiones"],
  mission: ["Escenarios/Misiones"],
  escenarios: ["Escenarios/Misiones"],
  misiones: ["Escenarios/Misiones"],
  "escenarios-y-misiones": ["Escenarios/Misiones"],
  "scenario-mission-campaign-game": ["Escenarios/Misiones"],
  "character-progression": ["Progresión de personaje"],
  "character-development": ["Progresión de personaje"],
  "progresion-personaje": ["Progresión de personaje"],
  "progresion-de-personaje": ["Progresión de personaje"],
  "desarrollo-de-personaje": ["Progresión de personaje"],
