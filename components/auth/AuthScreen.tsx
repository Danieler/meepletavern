...
export function AuthScreen({
  ...
  useEffect(() => {
    ...
    try {
      ...
      // Render with the current container width initially
      const initialWidth = parentContainer.clientWidth;
      renderButton(initialWidth);
      setGoogleButtonReady(true);

      // Listen to parent container resize to keep the Google button perfectly aligned
    ...
    <div className="mx-auto max-w-5xl px-4 py-4 sm:py-8">
      ...
      <div className="grid gap-8 lg:grid-cols-[minmax(0,1fr)_440px] lg:items-start">
        ...
        <section className="rounded-2xl border border-walnut/12 bg-white p-6 shadow-md md:p-8 transition-all hover:shadow-lg">
          ...
          <div ref={parentContainerRef} className="mx-auto flex w-full max-w-[400px] flex-col">
