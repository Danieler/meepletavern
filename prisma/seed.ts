...
const games = [
  {
    ...
    categories: ["Familiar", "Gateway", "Estrategia", "Clásicos modernos"],
    mechanics: ["Negociación", "Rutas y redes", "Gestión de recursos"],
  ...
  },
  {
    ...
    age: "7+",
    complexity: "Ligera",
    categories: ["Familiar", "Clásicos modernos"],
    mechanics: ["Colocación de losetas", "Mayorías", "Area control"],
  ...
  },
  {
    ...
    categories: ["Cooperativo", "Solitario", "Cartas", "Campaña / Legacy", "Terror"],
    mechanics: ["Deckbuilding", "Gestión de mano", "Campaña"],
  ...
  },
  {
    ...
    age: "8+",
    complexity: "Ligera",
    categories: ["Familiar", "Gateway"],
    mechanics: ["Set collection", "Rutas y redes"],
  ...
  },
  {
    ...
    age: "14+",
    complexity: "Media",
    categories: ["Aventura", "Cooperativo", "Campaña / Legacy", "Miniaturas", "Dungeon Crawler", "Fantasía"],
    mechanics: ["Cooperativo", "Campaña", "Combate con dados"],
